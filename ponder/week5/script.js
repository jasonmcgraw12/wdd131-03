...
const movies = [
    ...
    movies.forEach(movie => {
        ...
        const starLabel = movie.stars.length;
        newMovie.innerHTML = `
            <h2>${movie.title}</h2>
            ...
            <p><strong>Rating:</strong> <span aria-label="${starLabel} out of 5 stars" role="img">${movie.stars}</span></p>
            <p id='desc'>${movie.description}</p>
`        
        mainContent.appendChild(newMovie);
    });
